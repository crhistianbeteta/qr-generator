...
var WebAdapter = /** @class */ (function () {
    function WebAdapter(forGeneratingQR) {
        this.forGeneratingQR = forGeneratingQR;
    }
    WebAdapter.prototype.generate = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var url, generatedQr, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.forGeneratingQR.generateQR(url)];
                    case 2:
                        generatedQr = _a.sent();
